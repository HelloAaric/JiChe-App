...
void AllSeriesDeal_Sleep_Or_None(void) {
	...
	if(ChargerLoad_Func.bits.b1OFFDriver_Vdelta || System_ERROR_UserCallback(ERROR_STATUS_TEMP_BREAK)
		|| System_ERROR_UserCallback(ERROR_STATUS_AFE1)) {
		if(++su16_Sleep_Tcnt >= 60) {
			su16_Sleep_Tcnt = 0;
