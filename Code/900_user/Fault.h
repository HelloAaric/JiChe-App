...
#define E2P_PROTECT_MIN_PRT		{/*单节过压*/100,	100,	100,	100,	1,\
								 /*单节低压*/100,	100,	100,	100,	1,\
...
//磷酸铁锂
#elif (defined(LIFEPO))
#define E2P_PROTECT_DEFAULT_PRT	{/*单节过压*/3551,	3552,	3653,	3500,	101,\
								 /*单节低压*/2500,	2500,	2500,	2600,	102,\
								 /*总压过压*/355*SNum, 355*SNum,	365*SNum, 350*SNum, 100,\
								 /*总压低压*/250*SNum, 250*SNum,	250*SNum, 260*SNum, 100,\
		        				 /*充电过流*/1000,	1500,	2000,	500,	100,\
		        				 /*放电过流*/2000,	2500,	3000,	1000,	100,\
								 /*充电高温*/900,	900,	900,	850,	100,\
								 /*充电低温*/200,	200,	200,	400,	100,\
								 /*放电高温*/1000,	1000,	1000,	850,	100,\
								 /*放电低温*/100,	100,	100,	250,	100,\
		        				 /*驱动高温*/1200,	1200,	1200,	1000,	100,\
		        				 /*压差过大*/1000,	1000,	1000,	901,	102,\
		        				 /*电量过低*/3,		2,		1,		2,		100}

// 镍氢电池								 
#elif (defined(NICKEL))
#define E2P_PROTECT_DEFAULT_PRT	{/*单节过压*/1420,	1420,	1450,	1420,	100,\
								 /*单节低压*/1000 ,	1000,	900,	1000,	100,\
								 /*总压过压*/2840,  2840,	2900, 	2840, 	100,\
								 /*总压低压*/2100,  2000,	1800,   2000,   100,\
		        				 /*充电过流*/80,	100,	160,	30,		100,\
		        				 /*放电过流*/80,	120,	150,	20,		50,\
								 /*充电高温*/750,	750,	800,	750,	100,\
								 /*充电低温*/200,	200,	200,	400,	100,\
								 /*放电高温*/950,	950,	1000,	950,	100,\
								 /*放电低温*/100,	100,	100,	250,	100,\
		        				 /*驱动高温*/1200,	1200,	1200,	1000,	100,\
		        				 /*压差过大*/500,	500,	500,	300,	100,\
		        				 /*电量过低*/3,		2,		1,		2,		100}
#endif
